...
<head>
  ...
  <title>Formulario Registrar Empleado</title>
...
<body class="font-['Roboto']">
  <form class="w-11/12 sm:w-9/12 md:w-7/12 lg:w-5/12 xl:w-4/12 p-6 rounded-xl bg-gradient-to-br from-purple-600 to-blue-500 backdrop-blur-sm shadow-xl" method="POST" action="{{ route('admin.registrarEmpleado') }}">
    @csrf
    <div class="flex justify-center mb-4">
      <img src="/logo.Veterinaria.webp" alt="Logo" class="h-16 w-auto" />
    </div>
    <h2 class="text-white text-center font-bold text-2xl mb-6 select-none">Registrar Empleado</h2>
